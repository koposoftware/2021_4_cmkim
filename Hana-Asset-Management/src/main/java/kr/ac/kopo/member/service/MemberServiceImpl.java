...
public class MemberServiceImpl implements MemberService{
	...
	public void sendAttach(String email, String name, HttpSession session) {
	      ...
	      try {
	         ...
	         mail.setFrom("cndaks23@gmail.com", "9월호 정기리포트");   //보내는 사람 메일 / 이름 설정
	         mail.addTo(email, "김하나"); //받는 사람 메일 / 이름, 회원가입 페이지에에서 가져온다.
	         
	         String htmlStr = "안녕하세요 Hana Solution 입니다!"
	         		+ "\r\n" 
	 	            + "김하나님 9월 정기보고서 보내드립니다"
	 	            + "\r\n " 
	 	            + "비밀번호는 생년월일 6자리를 입력해주시면 됩니다"
	 	            + "\r\n " 
	 	            + "감사합니다.";
	         
	         mail.setSubject("9월호 정기 리포트 메일입니다."); //메일 제목
