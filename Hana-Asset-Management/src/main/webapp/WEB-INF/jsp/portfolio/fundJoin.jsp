...
<div class="notice-txt" >
	...
	<br>
	<div class="agree-box mt20" tabindex="0">
		   <div class="agree-txt">
		   <h4>구속행위 금지 안내</h4>
					 

            <dl>
                <dt class="bg-n font-14" style="font-size: 12pt;">구속행위란?</dt>
                <dd style="font-size: 11pt;">은행법(제52조의2) 및 은행법시행령(제24조의4)의 불공정영업행위의 금지와 관련하여 은행업감독규정 및 은행업감독업무시행세칙에서 규정한 사항입니다.
                    <ol class="list-txt mt10">
                        <li class="no">
                            <span class="font-c-or font-bold">1 . 차주 및 관계인(중소기업의 대표자)의 의사와 상관없이 구속행위로 간주되는 경우</span>
                            <ul>
                                <li class="no">Hana Solution에서는 여신(대출)거래와 관련하여 차주 및 관계인(중소기업의 대표자)을 보호하기 위하여 <em>여신(대출)실행일 </em><em>전/후 1개월 이내에 예금 등을 신규하는 경우 구속행위로 간주합니다.</em> (예적금, 상호부금, 금전신탁, 공제, 보험, 집합투자증권, 양도성예금증서, 금융채, 환매조건부채권, 선불카드, 선불전자지급수단, 상품권 등)</li>
                            </ul>
                        </li>
                        <li class="no"><span class="font-c-or font-bold">2 . 차주 및 관계인<sup>주)</sup>의 의사, 정당한 사유 여부 등 실질에 따라 구속행위로 간주되는 경우</span>
                            <ul class="ml10">
                                ...
                                <br><span class="ml10">주) 실질규제 대상 관계인은 중소기업의 임원(대표자 포함)·직원 및 그 가족(배우자 및 직계혈족)을 말합니다.</span>
                                </li>
                            </ul>
                        </li>
                    </ol>
            ...
            <ul>
                ...
                <li class="bg-n pl0 font-bold">변경시행일 : 2021년 3월 25일</li>
            </ul>
            <dl>
                <dt class="bg-n pl0">예금별 신규가능금액</dt>
                <dd class="bg-n pl0">금일 해지한 예금의 범위내에서는 가입이 가능합니다.</dd>
            </dl>
            <table class="tbl-type-1 ml10 ui-set-tbl-type" border="1" summary="해지예금, 재예치예금, 신규 가능한 금액, 비고 제공">
