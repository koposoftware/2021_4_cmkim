              ...
              <!-- Content -->
	            <div class="mt-2">
	              ...
	              <div class="grid grid-cols-1 gap-8 p-4 lg:grid-cols-2 xl:grid-cols-4">
	                ...
	                <div class="flex items-center justify-between p-4 bg-white rounded-md dark:bg-darker">
	                  <div>
	                  <c:if test="${ myReport eq 'investStyle' }">
	                    <a
	                      class="text-xs font-medium leading-none tracking-wider text-gray-500 uppercase dark:text-primary-light"
	                      style="font-size: 12pt; color: #3CC8C8;"
	                  ...
	                  <c:if test="${ myReport ne 'investStyle' }">
	                    <a
	                      class="text-xs font-medium leading-none tracking-wider text-gray-500 uppercase dark:text-primary-light"
	                      style="font-size: 12pt;"
	                      href="${ pageContext.request.contextPath }/myPage/investStyle"
	              ...
	              <!-- Two grid columns -->
	                ...
	                <div class="col-span-2 bg-white rounded-md dark:bg-darker" x-data="{ isOn: false }" style="width: 98%; margin-left: 15px;">
	                  ...
	                  <div class="flex items-center justify-between p-4 border-b dark:border-primary">
	                    <h4 class="text-lg font-semibold text-gray-500 dark:text-light" style="color: #3CC8C8">투자스타일</h4>
	                  ...
	                  <div style="width: 100%;">
						...
						<div class="psw_asset_wrap">
							<div class="psw_myw_wrap" style="width: 95%;">
								
								<div class="psw_content" style="width: 70%;">
									<h3 class="psw_asset_tit1" style="font-size: 20pt; text-align: center;"><strong>투자스타일</strong></h3>
				
									<p class="cont_desc_big">
										${ userVO.name }님의 거래패턴을 분석하고 투자스타일을 도출하여<br>
										<strong class="point_bar blue_l"><i></i>적합한 투자비중</strong>을 안내드립니다.
									</p>
