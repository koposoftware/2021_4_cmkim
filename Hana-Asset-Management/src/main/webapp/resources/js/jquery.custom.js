...
//         $( '#nav > ul, #nav .menu > ul' ).hide();
	...
	$(".gallery-wrap .internal_page_item, .section .related_project > div").on( 'mouseover mouseout', function(event){ 
	...
	//$('.gallery-categories-disabled, .portfolio-categories-disabled').on('click', function(e){
	//	e.preventDefault();
	//});
